...
HD_PWD='C:/Users/HP/Desktop/sedetector (2)/sedetector/sedetector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sqdetector_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sqdetector_display.tcl -notrace
