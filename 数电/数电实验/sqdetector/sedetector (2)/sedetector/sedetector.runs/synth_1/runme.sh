...
HD_PWD='F:/sedetector/sedetector/sedetector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sqdetector_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sqdetector_display.tcl
