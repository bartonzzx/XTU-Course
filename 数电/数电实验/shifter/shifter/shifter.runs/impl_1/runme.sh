...
HD_PWD='D:/D.ÎÄµµ/Êýµç/shifter/shifter/shifter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shifter_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shifter_display.tcl -notrace
