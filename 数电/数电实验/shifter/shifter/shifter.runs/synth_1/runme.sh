...
HD_PWD='D:/D.ÎÄµµ/Êýµç/shifter/shifter/shifter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shifter_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shifter_display.tcl
